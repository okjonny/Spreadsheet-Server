...
enum opt_code
{
  ...
  OPT_Wnonportable_cfstrings = 595,          /* -Wnonportable-cfstrings */
  ...
  OPT_Z = 750,                               /* -Z */
  OPT_Zall_load = 751,                       /* -Zall_load */
  OPT_Zallowable_client = 752,               /* -Zallowable_client */
  OPT_Zarch_errors_fatal = 753,              /* -Zarch_errors_fatal */
  OPT_Zbind_at_load = 754,                   /* -Zbind_at_load */
  OPT_Zbundle = 755,                         /* -Zbundle */
  OPT_Zbundle_loader = 756,                  /* -Zbundle_loader */
  OPT_Zdead_strip = 757,                     /* -Zdead_strip */
  OPT_Zdylib_file = 758,                     /* -Zdylib_file */
  OPT_Zdynamic = 759,                        /* -Zdynamic */
  OPT_Zdynamiclib = 760,                     /* -Zdynamiclib */
  OPT_Zexported_symbols_list = 761,          /* -Zexported_symbols_list */
  OPT_Zflat_namespace = 762,                 /* -Zflat_namespace */
  OPT_Zfn_seg_addr_table_filename = 763,     /* -Zfn_seg_addr_table_filename */
  OPT_Zforce_cpusubtype_ALL = 764,           /* -Zforce_cpusubtype_ALL */
  OPT_Zforce_flat_namespace = 765,           /* -Zforce_flat_namespace */
  OPT_Zimage_base = 766,                     /* -Zimage_base */
  OPT_Zinit = 767,                           /* -Zinit */
  OPT_Zinstall_name = 768,                   /* -Zinstall_name */
  OPT_Zmulti_module = 769,                   /* -Zmulti_module */
  OPT_Zmultiply_defined = 770,               /* -Zmultiply_defined */
  OPT_Zmultiplydefinedunused = 771,          /* -Zmultiplydefinedunused */
  OPT_Zno_dead_strip_inits_and_terms = 772,  /* -Zno_dead_strip_inits_and_terms */
  OPT_Zseg_addr_table = 773,                 /* -Zseg_addr_table */
  OPT_Zsegaddr = 774,                        /* -Zsegaddr */
  OPT_Zsegs_read_only_addr = 775,            /* -Zsegs_read_only_addr */
  OPT_Zsegs_read_write_addr = 776,           /* -Zsegs_read_write_addr */
  OPT_Zsingle_module = 777,                  /* -Zsingle_module */
  OPT_Zumbrella = 778,                       /* -Zumbrella */
  OPT_Zunexported_symbols_list = 779,        /* -Zunexported_symbols_list */
  OPT_Zweak_reference_mismatches = 780,      /* -Zweak_reference_mismatches */
  /* OPT_all_load = 781, */                  /* -all_load */
  /* OPT_allowable_client = 782, */          /* -allowable_client */
  OPT_ansi = 783,                            /* -ansi */
  OPT_arch = 784,                            /* -arch */
  /* OPT_arch_errors_fatal = 785, */         /* -arch_errors_fatal */
  OPT_asm_macosx_version_min_ = 786,         /* -asm_macosx_version_min= */
  OPT_aux_info = 787,                        /* -aux-info */
  /* OPT_aux_info_ = 788, */                 /* -aux-info= */
  OPT_auxbase = 789,                         /* -auxbase */
  OPT_auxbase_strip = 790,                   /* -auxbase-strip */
  /* OPT_bind_at_load = 791, */              /* -bind_at_load */
  /* OPT_bundle = 792, */                    /* -bundle */
  /* OPT_bundle_loader = 793, */             /* -bundle_loader */
  OPT_c = 794,                               /* -c */
  OPT_callgraph = 795,                       /* -callgraph */
  OPT_client_name = 796,                     /* -client_name */
  OPT_compatibility_version = 797,           /* -compatibility_version */
  OPT_coverage = 798,                        /* -coverage */
  OPT_cpp = 799,                             /* -cpp */
  OPT_cpp_ = 800,                            /* -cpp= */
  OPT_current_version = 801,                 /* -current_version */
  OPT_d = 802,                               /* -d */
  /* OPT_dead_strip = 803, */                /* -dead_strip */
  OPT_debuglib_ = 804,                       /* -debuglib= */
  OPT_defaultlib_ = 805,                     /* -defaultlib= */
  OPT_defined_only = 806,                    /* -defined-only */
  OPT_demangle = 807,                        /* -demangle */
  /* OPT_dependency_file = 808, */           /* -dependency-file */
  OPT_dstartfiles = 809,                     /* -dstartfiles */
  OPT_dump_body_ = 810,                      /* -dump-body= */
  OPT_dump_level_ = 811,                     /* -dump-level= */
  OPT_dumpbase = 812,                        /* -dumpbase */
  OPT_dumpdir = 813,                         /* -dumpdir */
  OPT_dumpfullversion = 814,                 /* -dumpfullversion */
  OPT_dumpmachine = 815,                     /* -dumpmachine */
  OPT_dumpspecs = 816,                       /* -dumpspecs */
  OPT_dumpversion = 817,                     /* -dumpversion */
  /* OPT_dylib_file = 818, */                /* -dylib_file */
  OPT_dylinker = 819,                        /* -dylinker */
  OPT_dylinker_install_name = 820,           /* -dylinker_install_name */
  /* OPT_dynamic = 821, */                   /* -dynamic */
  /* OPT_dynamiclib = 822, */                /* -dynamiclib */
  OPT_e = 823,                               /* -e */
  OPT_export_dynamic = 824,                  /* -export-dynamic */
  /* OPT_exported_symbols_list = 825, */     /* -exported_symbols_list */
  OPT_fPIC = 826,                            /* -fPIC */
  OPT_fPIE = 827,                            /* -fPIE */
  OPT_fRTS_ = 828,                           /* -fRTS= */
  ...
  OPT_fapple_kext = 867,                     /* -fapple-kext */
  ...
  OPT_fdiagnostics_format_ = 999,            /* -fdiagnostics-format= */
  OPT_fdiagnostics_generate_patch = 1000,    /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_minimum_margin_width_ = 1001,/* -fdiagnostics-minimum-margin-width= */
  OPT_fdiagnostics_parseable_fixits = 1002,  /* -fdiagnostics-parseable-fixits */
  OPT_fdiagnostics_path_format_ = 1003,      /* -fdiagnostics-path-format= */
  OPT_fdiagnostics_show_caret = 1004,        /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_cwe = 1005,          /* -fdiagnostics-show-cwe */
  OPT_fdiagnostics_show_labels = 1006,       /* -fdiagnostics-show-labels */
  OPT_fdiagnostics_show_line_numbers = 1007, /* -fdiagnostics-show-line-numbers */
  OPT_fdiagnostics_show_location_ = 1008,    /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 1009,       /* -fdiagnostics-show-option */
  OPT_fdiagnostics_show_path_depths = 1010,  /* -fdiagnostics-show-path-depths */
  OPT_fdiagnostics_show_template_tree = 1011,/* -fdiagnostics-show-template-tree */
  OPT_fdiagnostics_urls_ = 1012,             /* -fdiagnostics-urls= */
  OPT_fdirectives_only = 1013,               /* -fdirectives-only */
  OPT_fdisable_ = 1014,                      /* -fdisable- */
  OPT_fdoc = 1015,                           /* -fdoc */
  OPT_fdoc_dir_ = 1016,                      /* -fdoc-dir= */
  OPT_fdoc_file_ = 1017,                     /* -fdoc-file= */
  OPT_fdoc_inc_ = 1018,                      /* -fdoc-inc= */
  OPT_fdollar_ok = 1019,                     /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 1020,        /* -fdollars-in-identifiers */
  OPT_fdruntime = 1021,                      /* -fdruntime */
  OPT_fdse = 1022,                           /* -fdse */
  OPT_fdump_ = 1023,                         /* -fdump- */
  OPT_fdump_ada_spec = 1024,                 /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 1025,            /* -fdump-ada-spec-slim */
  OPT_fdump_analyzer = 1026,                 /* -fdump-analyzer */
  OPT_fdump_analyzer_callgraph = 1027,       /* -fdump-analyzer-callgraph */
  OPT_fdump_analyzer_exploded_graph = 1028,  /* -fdump-analyzer-exploded-graph */
  OPT_fdump_analyzer_exploded_nodes = 1029,  /* -fdump-analyzer-exploded-nodes */
  OPT_fdump_analyzer_exploded_nodes_2 = 1030,/* -fdump-analyzer-exploded-nodes-2 */
  OPT_fdump_analyzer_exploded_nodes_3 = 1031,/* -fdump-analyzer-exploded-nodes-3 */
  OPT_fdump_analyzer_state_purge = 1032,     /* -fdump-analyzer-state-purge */
  OPT_fdump_analyzer_stderr = 1033,          /* -fdump-analyzer-stderr */
  OPT_fdump_analyzer_supergraph = 1034,      /* -fdump-analyzer-supergraph */
  /* OPT_fdump_core = 1035, */               /* -fdump-core */
  OPT_fdump_d_original = 1036,               /* -fdump-d-original */
  OPT_fdump_final_insns = 1037,              /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 1038,             /* -fdump-final-insns= */
  OPT_fdump_fortran_global = 1039,           /* -fdump-fortran-global */
  OPT_fdump_fortran_optimized = 1040,        /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 1041,         /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 1042,                 /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 1043,       /* -fdump-internal-locations */
  OPT_fdump_noaddr = 1044,                   /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 1045, */         /* -fdump-parse-tree */
  OPT_fdump_passes = 1046,                   /* -fdump-passes */
  OPT_fdump_scos = 1047,                     /* -fdump-scos */
  OPT_fdump_unnumbered = 1048,               /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 1049,         /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 1050,                /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 1051,                /* -fearly-inlining */
  OPT_felide_constructors = 1052,            /* -felide-constructors */
  OPT_felide_type = 1053,                    /* -felide-type */
  /* OPT_feliminate_dwarf2_dups = 1054, */   /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 1055,/* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 1056,  /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 1057,       /* -femit-class-debug-always */
  OPT_femit_struct_debug_baseonly = 1058,    /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 1059,   /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 1060,     /* -femit-struct-debug-reduced */
  OPT_fenable_ = 1061,                       /* -fenable- */
  OPT_fenforce_eh_specs = 1062,              /* -fenforce-eh-specs */
  OPT_fenum_int_equiv = 1063,                /* -fenum-int-equiv */
  OPT_fexceptions = 1064,                    /* -fexceptions */
  OPT_fexcess_precision_ = 1065,             /* -fexcess-precision= */
  OPT_fexec_charset_ = 1066,                 /* -fexec-charset= */
  OPT_fexpensive_optimizations = 1067,       /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 1068,          /* -fext-numeric-literals */
  OPT_fextended_identifiers = 1069,          /* -fextended-identifiers */
  OPT_fextern_tls_init = 1070,               /* -fextern-tls-init */
  OPT_fexternal_blas = 1071,                 /* -fexternal-blas */
  OPT_fexternal_templates = 1072,            /* -fexternal-templates */
  OPT_ff2c = 1073,                           /* -ff2c */
  OPT_ffast_math = 1074,                     /* -ffast-math */
  OPT_ffat_lto_objects = 1075,               /* -ffat-lto-objects */
  OPT_ffile_prefix_map_ = 1076,              /* -ffile-prefix-map= */
  OPT_ffinite_loops = 1077,                  /* -ffinite-loops */
  OPT_ffinite_math_only = 1078,              /* -ffinite-math-only */
  OPT_ffixed_ = 1079,                        /* -ffixed- */
  OPT_ffixed_form = 1080,                    /* -ffixed-form */
  OPT_ffixed_line_length_ = 1081,            /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 1082,        /* -ffixed-line-length-none */
  OPT_ffloat_store = 1083,                   /* -ffloat-store */
  OPT_ffor_scope = 1084,                     /* -ffor-scope */
  /* OPT_fforce_addr = 1085, */              /* -fforce-addr */
  OPT_fforward_propagate = 1086,             /* -fforward-propagate */
  OPT_ffp_contract_ = 1087,                  /* -ffp-contract= */
  OPT_ffp_int_builtin_inexact = 1088,        /* -ffp-int-builtin-inexact */
  OPT_ffpe_summary_ = 1089,                  /* -ffpe-summary= */
  OPT_ffpe_trap_ = 1090,                     /* -ffpe-trap= */
  OPT_ffree_form = 1091,                     /* -ffree-form */
  OPT_ffree_line_length_ = 1092,             /* -ffree-line-length- */
  OPT_ffree_line_length_none = 1093,         /* -ffree-line-length-none */
  OPT_ffreestanding = 1094,                  /* -ffreestanding */
  OPT_ffriend_injection = 1095,              /* -ffriend-injection */
  OPT_ffrontend_loop_interchange = 1096,     /* -ffrontend-loop-interchange */
  OPT_ffrontend_optimize = 1097,             /* -ffrontend-optimize */
  OPT_ffunction_cse = 1098,                  /* -ffunction-cse */
  OPT_ffunction_sections = 1099,             /* -ffunction-sections */
  OPT_fgcse = 1100,                          /* -fgcse */
  OPT_fgcse_after_reload = 1101,             /* -fgcse-after-reload */
  OPT_fgcse_las = 1102,                      /* -fgcse-las */
  OPT_fgcse_lm = 1103,                       /* -fgcse-lm */
  OPT_fgcse_sm = 1104,                       /* -fgcse-sm */
  OPT_fgimple = 1105,                        /* -fgimple */
  OPT_fgnat_encodings_ = 1106,               /* -fgnat-encodings= */
  OPT_fgnu_keywords = 1107,                  /* -fgnu-keywords */
  OPT_fgnu_runtime = 1108,                   /* -fgnu-runtime */
  OPT_fgnu_tm = 1109,                        /* -fgnu-tm */
  OPT_fgnu_unique = 1110,                    /* -fgnu-unique */
  OPT_fgnu89_inline = 1111,                  /* -fgnu89-inline */
  OPT_fgo_c_header_ = 1112,                  /* -fgo-c-header= */
  OPT_fgo_check_divide_overflow = 1113,      /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 1114,          /* -fgo-check-divide-zero */
  OPT_fgo_compiling_runtime = 1115,          /* -fgo-compiling-runtime */
  OPT_fgo_debug_escape = 1116,               /* -fgo-debug-escape */
  OPT_fgo_debug_escape_hash_ = 1117,         /* -fgo-debug-escape-hash= */
  OPT_fgo_debug_optimization = 1118,         /* -fgo-debug-optimization */
  OPT_fgo_dump_ = 1119,                      /* -fgo-dump- */
  OPT_fgo_optimize_ = 1120,                  /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 1121,                   /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 1122,                    /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 1123,      /* -fgo-relative-import-path= */
  OPT_fgraphite = 1124,                      /* -fgraphite */
  OPT_fgraphite_identity = 1125,             /* -fgraphite-identity */
  OPT_fguess_branch_probability = 1126,      /* -fguess-branch-probability */
  OPT_fguiding_decls = 1127,                 /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 1128, */       /* -fhandle-exceptions */
  /* OPT_fhelp = 1129, */                    /* -fhelp */
  /* OPT_fhelp_ = 1130, */                   /* -fhelp= */
  OPT_fhoist_adjacent_loads = 1131,          /* -fhoist-adjacent-loads */
  OPT_fhonor_std = 1132,                     /* -fhonor-std */
  OPT_fhosted = 1133,                        /* -fhosted */
  OPT_fhuge_objects = 1134,                  /* -fhuge-objects */
  OPT_fident = 1135,                         /* -fident */
  OPT_fif_conversion = 1136,                 /* -fif-conversion */
  OPT_fif_conversion2 = 1137,                /* -fif-conversion2 */
  OPT_fignore_unknown_pragmas = 1138,        /* -fignore-unknown-pragmas */
  OPT_filelist = 1139,                       /* -filelist */
  OPT_fimplement_inlines = 1140,             /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 1141,     /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 1142,                 /* -fimplicit-none */
  OPT_fimplicit_templates = 1143,            /* -fimplicit-templates */
  OPT_findirect_inlining = 1144,             /* -findirect-inlining */
  OPT_findirect_virtual_calls = 1145,        /* -findirect-virtual-calls */
  OPT_finhibit_size_directive = 1146,        /* -finhibit-size-directive */
  OPT_finit_character_ = 1147,               /* -finit-character= */
  OPT_finit_derived = 1148,                  /* -finit-derived */
  OPT_finit_integer_ = 1149,                 /* -finit-integer= */
  OPT_finit_local_zero = 1150,               /* -finit-local-zero */
  OPT_finit_logical_ = 1151,                 /* -finit-logical= */
  OPT_finit_real_ = 1152,                    /* -finit-real= */
  OPT_finline = 1153,                        /* -finline */
  OPT_finline_arg_packing = 1154,            /* -finline-arg-packing */
  OPT_finline_atomics = 1155,                /* -finline-atomics */
  OPT_finline_functions = 1156,              /* -finline-functions */
  OPT_finline_functions_called_once = 1157,  /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 1158, */           /* -finline-limit- */
  OPT_finline_limit_ = 1159,                 /* -finline-limit= */
  OPT_finline_matmul_limit_ = 1160,          /* -finline-matmul-limit= */
  OPT_finline_small_functions = 1161,        /* -finline-small-functions */
  OPT_finput_charset_ = 1162,                /* -finput-charset= */
  OPT_finstrument_functions = 1163,          /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 1164,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 1165,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 1166,           /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 1167,        /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 1168,       /* -fintrinsic-modules-path= */
  OPT_finvariants = 1169,                    /* -finvariants */
  OPT_fipa_bit_cp = 1170,                    /* -fipa-bit-cp */
  OPT_fipa_cp = 1171,                        /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 1172, */        /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 1173,                  /* -fipa-cp-clone */
  OPT_fipa_icf = 1174,                       /* -fipa-icf */
  OPT_fipa_icf_functions = 1175,             /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 1176,             /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 1177, */        /* -fipa-matrix-reorg */
  OPT_fipa_profile = 1178,                   /* -fipa-profile */
  OPT_fipa_pta = 1179,                       /* -fipa-pta */
  OPT_fipa_pure_const = 1180,                /* -fipa-pure-const */
  OPT_fipa_ra = 1181,                        /* -fipa-ra */
  OPT_fipa_reference = 1182,                 /* -fipa-reference */
  OPT_fipa_reference_addressable = 1183,     /* -fipa-reference-addressable */
  OPT_fipa_sra = 1184,                       /* -fipa-sra */
  OPT_fipa_stack_alignment = 1185,           /* -fipa-stack-alignment */
  /* OPT_fipa_struct_reorg = 1186, */        /* -fipa-struct-reorg */
  OPT_fipa_vrp = 1187,                       /* -fipa-vrp */
  OPT_fira_algorithm_ = 1188,                /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 1189,            /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 1190,             /* -fira-loop-pressure */
  OPT_fira_region_ = 1191,                   /* -fira-region= */
  OPT_fira_share_save_slots = 1192,          /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 1193,         /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 1194,                  /* -fira-verbose= */
  OPT_fisolate_erroneous_paths_attribute = 1195,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 1196,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 1197,              /* -fivar-visibility= */
  OPT_fivopts = 1198,                        /* -fivopts */
  OPT_fjump_tables = 1199,                   /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 1200,            /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 1201,         /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 1202,         /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 1203,            /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 1204,         /* -fkeep-static-functions */
  OPT_flabels_ok = 1205,                     /* -flabels-ok */
  /* OPT_flat_namespace = 1206, */           /* -flat_namespace */
  OPT_flax_vector_conversions = 1207,        /* -flax-vector-conversions */
  OPT_fleading_underscore = 1208,            /* -fleading-underscore */
  OPT_flifetime_dse = 1209,                  /* -flifetime-dse */
  OPT_flifetime_dse_ = 1210,                 /* -flifetime-dse= */
  OPT_flimit_function_alignment = 1211,      /* -flimit-function-alignment */
  OPT_flinker_output_ = 1212,                /* -flinker-output= */
  /* OPT_flive_patching = 1213, */           /* -flive-patching */
  OPT_flive_patching_ = 1214,                /* -flive-patching= */
  OPT_flive_range_shrinkage = 1215,          /* -flive-range-shrinkage */
  OPT_flocal_ivars = 1216,                   /* -flocal-ivars */
  /* OPT_floop_block = 1217, */              /* -floop-block */
  /* OPT_floop_flatten = 1218, */            /* -floop-flatten */
  OPT_floop_interchange = 1219,              /* -floop-interchange */
  OPT_floop_nest_optimize = 1220,            /* -floop-nest-optimize */
  /* OPT_floop_optimize = 1221, */           /* -floop-optimize */
  OPT_floop_parallelize_all = 1222,          /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 1223, */         /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 1224,           /* -floop-unroll-and-jam */
  OPT_flra_remat = 1225,                     /* -flra-remat */
  OPT_flto = 1226,                           /* -flto */
  OPT_flto_compression_level_ = 1227,        /* -flto-compression-level= */
  /* OPT_flto_odr_type_merging = 1228, */    /* -flto-odr-type-merging */
  OPT_flto_partition_ = 1229,                /* -flto-partition= */
  OPT_flto_report = 1230,                    /* -flto-report */
  OPT_flto_report_wpa = 1231,                /* -flto-report-wpa */
  OPT_flto_ = 1232,                          /* -flto= */
  OPT_fltrans = 1233,                        /* -fltrans */
  OPT_fltrans_output_list_ = 1234,           /* -fltrans-output-list= */
  OPT_fmacro_prefix_map_ = 1235,             /* -fmacro-prefix-map= */
  OPT_fmain = 1236,                          /* -fmain */
  OPT_fmath_errno = 1237,                    /* -fmath-errno */
  OPT_fmax_array_constructor_ = 1238,        /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 1239,                   /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 1240,        /* -fmax-identifier-length= */
  OPT_fmax_include_depth_ = 1241,            /* -fmax-include-depth= */
  OPT_fmax_stack_var_size_ = 1242,           /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 1243,         /* -fmax-subrecord-length= */
  OPT_fmem_report = 1244,                    /* -fmem-report */
  OPT_fmem_report_wpa = 1245,                /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 1246,           /* -fmerge-all-constants */
  OPT_fmerge_constants = 1247,               /* -fmerge-constants */
  OPT_fmerge_debug_strings = 1248,           /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 1249,               /* -fmessage-length= */
  OPT_fmodule_file_ = 1250,                  /* -fmodule-file= */
  OPT_fmodule_private = 1251,                /* -fmodule-private */
  OPT_fmoduleinfo = 1252,                    /* -fmoduleinfo */
  OPT_fmodulo_sched = 1253,                  /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 1254,   /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 1255,          /* -fmove-loop-invariants */
  OPT_fms_extensions = 1256,                 /* -fms-extensions */
  OPT_fmudflap = 1257,                       /* -fmudflap */
  OPT_fmudflapir = 1258,                     /* -fmudflapir */
  OPT_fmudflapth = 1259,                     /* -fmudflapth */
  OPT_fname_mangling_version_ = 1260,        /* -fname-mangling-version- */
  OPT_fnew_abi = 1261,                       /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 1262,          /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 1263,              /* -fnew-ttp-matching */
  OPT_fnext_runtime = 1264,                  /* -fnext-runtime */
  OPT_fnil_receivers = 1265,                 /* -fnil-receivers */
  OPT_fnon_call_exceptions = 1266,           /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 1267,              /* -fnonansi-builtins */
  OPT_fnonnull_objects = 1268,               /* -fnonnull-objects */
  OPT_fnothrow_opt = 1269,                   /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 1270,             /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 1271,          /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 1272,          /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 1273,               /* -fobjc-exceptions */
  OPT_fobjc_gc = 1274,                       /* -fobjc-gc */
  OPT_fobjc_nilcheck = 1275,                 /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 1276,          /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 1277,                /* -fobjc-std=objc1 */
  OPT_foffload_abi_ = 1278,                  /* -foffload-abi= */
  OPT_foffload_ = 1279,                      /* -foffload= */
  OPT_fomit_frame_pointer = 1280,            /* -fomit-frame-pointer */
  OPT_fonly_ = 1281,                         /* -fonly= */
  OPT_fopenacc = 1282,                       /* -fopenacc */
  OPT_fopenacc_dim_ = 1283,                  /* -fopenacc-dim= */
  OPT_fopenmp = 1284,                        /* -fopenmp */
  OPT_fopenmp_simd = 1285,                   /* -fopenmp-simd */
  OPT_foperator_names = 1286,                /* -foperator-names */
  OPT_fopt_info = 1287,                      /* -fopt-info */
  OPT_fopt_info_ = 1288,                     /* -fopt-info- */
  /* OPT_foptimize_register_move = 1289, */  /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 1290,        /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 1291,               /* -foptimize-strlen */
  /* OPT_foptional_diags = 1292, */          /* -foptional-diags */
  /* OPT_force_cpusubtype_ALL = 1293, */     /* -force_cpusubtype_ALL */
  /* OPT_force_flat_namespace = 1294, */     /* -force_flat_namespace */
  OPT_fpack_derived = 1295,                  /* -fpack-derived */
  OPT_fpack_struct = 1296,                   /* -fpack-struct */
  OPT_fpack_struct_ = 1297,                  /* -fpack-struct= */
  OPT_fpad_source = 1298,                    /* -fpad-source */
  OPT_fpartial_inlining = 1299,              /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 1300,     /* -fpatchable-function-entry= */
  OPT_fpcc_struct_return = 1301,             /* -fpcc-struct-return */
  OPT_fpch_deps = 1302,                      /* -fpch-deps */
  OPT_fpch_preprocess = 1303,                /* -fpch-preprocess */
  OPT_fpeel_loops = 1304,                    /* -fpeel-loops */
  OPT_fpeephole = 1305,                      /* -fpeephole */
  OPT_fpeephole2 = 1306,                     /* -fpeephole2 */
  OPT_fpermissive = 1307,                    /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 1308,   /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 1309,                           /* -fpic */
  OPT_fpie = 1310,                           /* -fpie */
  OPT_fplan9_extensions = 1311,              /* -fplan9-extensions */
  OPT_fplt = 1312,                           /* -fplt */
  OPT_fplugin_arg_ = 1313,                   /* -fplugin-arg- */
  OPT_fplugin_ = 1314,                       /* -fplugin= */
  OPT_fpost_ipa_mem_report = 1315,           /* -fpost-ipa-mem-report */
  OPT_fpostconditions = 1316,                /* -fpostconditions */
  OPT_fpre_include_ = 1317,                  /* -fpre-include= */
  OPT_fpre_ipa_mem_report = 1318,            /* -fpre-ipa-mem-report */
  OPT_fpreconditions = 1319,                 /* -fpreconditions */
  OPT_fpredictive_commoning = 1320,          /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 1321,          /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 1322,                  /* -fpreprocessed */
  OPT_fpretty_templates = 1323,              /* -fpretty-templates */
  OPT_fprintf_return_value = 1324,           /* -fprintf-return-value */
  OPT_fprofile = 1325,                       /* -fprofile */
  OPT_fprofile_abs_path = 1326,              /* -fprofile-abs-path */
  OPT_fprofile_arcs = 1327,                  /* -fprofile-arcs */
  OPT_fprofile_correction = 1328,            /* -fprofile-correction */
  OPT_fprofile_dir_ = 1329,                  /* -fprofile-dir= */
  OPT_fprofile_exclude_files_ = 1330,        /* -fprofile-exclude-files= */
  OPT_fprofile_filter_files_ = 1331,         /* -fprofile-filter-files= */
  OPT_fprofile_generate = 1332,              /* -fprofile-generate */
  OPT_fprofile_generate_ = 1333,             /* -fprofile-generate= */
  OPT_fprofile_note_ = 1334,                 /* -fprofile-note= */
  OPT_fprofile_partial_training = 1335,      /* -fprofile-partial-training */
  OPT_fprofile_prefix_path_ = 1336,          /* -fprofile-prefix-path= */
  OPT_fprofile_reorder_functions = 1337,     /* -fprofile-reorder-functions */
  OPT_fprofile_report = 1338,                /* -fprofile-report */
  OPT_fprofile_reproducible = 1339,          /* -fprofile-reproducible */
  OPT_fprofile_update_ = 1340,               /* -fprofile-update= */
  OPT_fprofile_use = 1341,                   /* -fprofile-use */
  OPT_fprofile_use_ = 1342,                  /* -fprofile-use= */
  OPT_fprofile_values = 1343,                /* -fprofile-values */
  OPT_fprotect_parens = 1344,                /* -fprotect-parens */
  OPT_framework = 1345,                      /* -framework */
  OPT_frandom_seed = 1346,                   /* -frandom-seed */
  OPT_frandom_seed_ = 1347,                  /* -frandom-seed= */
  OPT_frange_check = 1348,                   /* -frange-check */
  OPT_freal_4_real_10 = 1349,                /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 1350,                /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 1351,                 /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 1352,                /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 1353,                /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 1354,                 /* -freal-8-real-4 */
  OPT_frealloc_lhs = 1355,                   /* -frealloc-lhs */
  OPT_freciprocal_math = 1356,               /* -freciprocal-math */
  OPT_frecord_gcc_switches = 1357,           /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 1358,               /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 1359,               /* -frecord-marker=8 */
  OPT_frecursive = 1360,                     /* -frecursive */
  OPT_free = 1361,                           /* -free */
  OPT_freg_struct_return = 1362,             /* -freg-struct-return */
  /* OPT_fregmove = 1363, */                 /* -fregmove */
  OPT_frelease = 1364,                       /* -frelease */
  OPT_frename_registers = 1365,              /* -frename-registers */
  OPT_freorder_blocks = 1366,                /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 1367,     /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 1368,  /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 1369,             /* -freorder-functions */
  OPT_frepack_arrays = 1370,                 /* -frepack-arrays */
  OPT_freplace_objc_classes = 1371,          /* -freplace-objc-classes */
  OPT_frepo = 1372,                          /* -frepo */
  OPT_freport_bug = 1373,                    /* -freport-bug */
  OPT_frequire_return_statement = 1374,      /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 1375,          /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 1376, */          /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 1377,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 1378,                   /* -fresolution= */
  OPT_frounding_math = 1379,                 /* -frounding-math */
  OPT_frtti = 1380,                          /* -frtti */
  OPT_fsanitize_address_use_after_scope = 1381,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 1382,            /* -fsanitize-coverage= */
  OPT_fsanitize_recover = 1383,              /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 1384,             /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 1385,            /* -fsanitize-sections= */
  OPT_fsanitize_undefined_trap_on_error = 1386,/* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 1387,                     /* -fsanitize= */
  OPT_fsave_optimization_record = 1388,      /* -fsave-optimization-record */
  OPT_fsched_critical_path_heuristic = 1389, /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 1390,     /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 1391,         /* -fsched-group-heuristic */
  OPT_fsched_interblock = 1392,              /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 1393,     /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 1394,                /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 1395,          /* -fsched-rank-heuristic */
  OPT_fsched_spec = 1396,                    /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 1397,     /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 1398,               /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 1399,     /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 1400,           /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 1401,       /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 1402,      /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 1403,          /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 1404,                /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 1405,        /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 1406, */       /* -fsched2-use-traces */
  OPT_fschedule_fusion = 1407,               /* -fschedule-fusion */
  OPT_fschedule_insns = 1408,                /* -fschedule-insns */
  OPT_fschedule_insns2 = 1409,               /* -fschedule-insns2 */
  OPT_fsecond_underscore = 1410,             /* -fsecond-underscore */
  OPT_fsection_anchors = 1411,               /* -fsection-anchors */
  /* OPT_fsee = 1412, */                     /* -fsee */
  OPT_fsel_sched_pipelining = 1413,          /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 1414,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 1415,/* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 1416,          /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 1417,         /* -fselective-scheduling2 */
  OPT_fself_test_ = 1418,                    /* -fself-test= */
  OPT_fsemantic_interposition = 1419,        /* -fsemantic-interposition */
  OPT_fshort_enums = 1420,                   /* -fshort-enums */
  OPT_fshort_wchar = 1421,                   /* -fshort-wchar */
  OPT_fshow_column = 1422,                   /* -fshow-column */
  OPT_fshrink_wrap = 1423,                   /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 1424,          /* -fshrink-wrap-separate */
  OPT_fsign_zero = 1425,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1426,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1427,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1428,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1429,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1430,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1431,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1432,            /* -fsized-deallocation */
  OPT_fsplit_ivs_in_unroller = 1433,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1434,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1435,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1436,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1437,              /* -fsplit-wide-types */
  OPT_fsplit_wide_types_early = 1438,        /* -fsplit-wide-types-early */
  OPT_fsquangle = 1439,                      /* -fsquangle */
  OPT_fssa_backprop = 1440,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1441,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1442,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1443,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1444, */             /* -fstack-check */
  OPT_fstack_check_ = 1445,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1446,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1447,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1448,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1449,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1450,               /* -fstack-protector */
  OPT_fstack_protector_all = 1451,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1452,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1453,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1454,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1455,                   /* -fstack-usage */
  OPT_fstats = 1456,                         /* -fstats */
  OPT_fstdarg_opt = 1457,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1458,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1459, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1460,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1461,                  /* -fstrict-enums */
  OPT_fstrict_overflow = 1462,               /* -fstrict-overflow */
  OPT_fstrict_prototype = 1463,              /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1464,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1465, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1466,            /* -fstrong-eval-order= */
  OPT_fswitch_errors = 1467,                 /* -fswitch-errors */
  OPT_fsync_libcalls = 1468,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1469,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1470,                      /* -ftabstop= */
  /* OPT_ftail_call_workaround = 1471, */    /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 1472,         /* -ftail-call-workaround= */
  /* OPT_ftarget_help = 1473, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1474,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1475, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1476,               /* -ftemplate-depth= */
  OPT_fterminated_vtables = 1477,            /* -fterminated-vtables */
  OPT_ftest_coverage = 1478,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1479,              /* -ftest-forall-temp */
  OPT_fthis_is_variable = 1480,              /* -fthis-is-variable */
  OPT_fthread_jumps = 1481,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1482,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1483,                   /* -ftime-report */
  OPT_ftime_report_details = 1484,           /* -ftime-report-details */
  OPT_ftls_model_ = 1485,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1486,              /* -ftoplevel-reorder */
  OPT_ftracer = 1487,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1488,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1489,        /* -ftrack-macro-expansion= */
  OPT_ftrampolines = 1490,                   /* -ftrampolines */
  OPT_ftransition_all = 1491,                /* -ftransition=all */
  OPT_ftransition_checkimports = 1492,       /* -ftransition=checkimports */
  OPT_ftransition_complex = 1493,            /* -ftransition=complex */
  OPT_ftransition_dip1000 = 1494,            /* -ftransition=dip1000 */
  OPT_ftransition_dip25 = 1495,              /* -ftransition=dip25 */
  OPT_ftransition_field = 1496,              /* -ftransition=field */
  OPT_ftransition_import = 1497,             /* -ftransition=import */
  OPT_ftransition_nogc = 1498,               /* -ftransition=nogc */
  OPT_ftransition_tls = 1499,                /* -ftransition=tls */
  OPT_ftrapping_math = 1500,                 /* -ftrapping-math */
  OPT_ftrapv = 1501,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1502,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1503,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1504,                      /* -ftree-ccp */
  OPT_ftree_ch = 1505,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1506, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1507,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1508,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1509, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1510,                   /* -ftree-cselim */
  OPT_ftree_dce = 1511,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1512,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1513,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1514,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1515,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1516, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1517,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1518,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1519, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1520,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1521,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1522, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1523,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1524,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1525,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1526,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1527,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1528,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1529,                      /* -ftree-pre */
  OPT_ftree_pta = 1530,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1531,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1532, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1533,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1534,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1535,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1536,                     /* -ftree-slsr */
  OPT_ftree_sra = 1537,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1538, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1539, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1540,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1541,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1542,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1543, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1544,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1545, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1546,                      /* -ftree-vrp */
  OPT_funconstrained_commons = 1547,         /* -funconstrained-commons */
  OPT_funderscoring = 1548,                  /* -funderscoring */
  OPT_funit_at_a_time = 1549,                /* -funit-at-a-time */
  OPT_funittest = 1550,                      /* -funittest */
  OPT_funroll_all_loops = 1551,              /* -funroll-all-loops */
  OPT_funroll_completely_grow_size = 1552,   /* -funroll-completely-grow-size */
  OPT_funroll_loops = 1553,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1554, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1555,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1556,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1557,                 /* -funsigned-char */
  OPT_funswitch_loops = 1558,                /* -funswitch-loops */
  OPT_funwind_tables = 1559,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1560,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1561,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1562,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1563,                   /* -fuse-ld=gold */
  OPT_fuse_ld_lld = 1564,                    /* -fuse-ld=lld */
  OPT_fuse_linker_plugin = 1565,             /* -fuse-linker-plugin */
  ...
  OPT_fxref = 1596,                          /* -fxref */
  /* OPT_fzee = 1597, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1598,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1599,                     /* -fzero-link */
  OPT_g = 1600,                              /* -g */
  OPT_gant = 1601,                           /* -gant */
  OPT_gas_loc_support = 1602,                /* -gas-loc-support */
  OPT_gas_locview_support = 1603,            /* -gas-locview-support */
  OPT_gcoff = 1604,                          /* -gcoff */
  OPT_gcoff1 = 1605,                         /* -gcoff1 */
  OPT_gcoff2 = 1606,                         /* -gcoff2 */
  OPT_gcoff3 = 1607,                         /* -gcoff3 */
  OPT_gcolumn_info = 1608,                   /* -gcolumn-info */
  OPT_gdescribe_dies = 1609,                 /* -gdescribe-dies */
  OPT_gdwarf = 1610,                         /* -gdwarf */
  OPT_gdwarf_ = 1611,                        /* -gdwarf- */
  OPT_gen_decls = 1612,                      /* -gen-decls */
  OPT_gfull = 1613,                          /* -gfull */
  OPT_ggdb = 1614,                           /* -ggdb */
  ...
  OPT_gused = 1631,                          /* -gused */
  OPT_gvariable_location_views = 1632,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 1633,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 1634,                           /* -gvms */
  OPT_gxcoff = 1635,                         /* -gxcoff */
  OPT_gxcoff_ = 1636,                        /* -gxcoff+ */
  OPT_gz = 1637,                             /* -gz */
  OPT_gz_ = 1638,                            /* -gz= */
  OPT_h = 1639,                              /* -h */
  OPT_headerpad_max_install_names = 1640,    /* -headerpad_max_install_names */
  OPT_help = 1641,                           /* -help */
  OPT_idirafter = 1642,                      /* -idirafter */
  OPT_iframework = 1643,                     /* -iframework */
  OPT_imacros = 1644,                        /* -imacros */
  /* OPT_image_base = 1645, */               /* -image_base */
  OPT_imultiarch = 1646,                     /* -imultiarch */
  OPT_imultilib = 1647,                      /* -imultilib */
  OPT_include = 1648,                        /* -include */
  /* OPT_init = 1649, */                     /* -init */
  /* OPT_install_name = 1650, */             /* -install_name */
  OPT_iplugindir_ = 1651,                    /* -iplugindir= */
  OPT_iprefix = 1652,                        /* -iprefix */
  OPT_iquote = 1653,                         /* -iquote */
  OPT_isysroot = 1654,                       /* -isysroot */
  OPT_isystem = 1655,                        /* -isystem */
  OPT_iwithprefix = 1656,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1657,              /* -iwithprefixbefore */
  OPT_k8 = 1658,                             /* -k8 */
  OPT_keep_private_externs = 1659,           /* -keep_private_externs */
  OPT_l = 1660,                              /* -l */
  OPT_lang_asm = 1661,                       /* -lang-asm */
  OPT_list = 1662,                           /* -list */
  OPT_m128bit_long_double = 1663,            /* -m128bit-long-double */
  OPT_m16 = 1664,                            /* -m16 */
  OPT_m32 = 1665,                            /* -m32 */
  OPT_m3dnow = 1666,                         /* -m3dnow */
  OPT_m3dnowa = 1667,                        /* -m3dnowa */
  OPT_m64 = 1668,                            /* -m64 */
  OPT_m80387 = 1669,                         /* -m80387 */
  OPT_m8bit_idiv = 1670,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1671,             /* -m96bit-long-double */
  OPT_mabi_ = 1672,                          /* -mabi= */
  OPT_mabm = 1673,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1674,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1675,                 /* -maddress-mode= */
  OPT_madx = 1676,                           /* -madx */
  OPT_maes = 1677,                           /* -maes */
  OPT_malign_data_ = 1678,                   /* -malign-data= */
  OPT_malign_double = 1679,                  /* -malign-double */
  OPT_malign_functions_ = 1680,              /* -malign-functions= */
  OPT_malign_jumps_ = 1681,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1682,                  /* -malign-loops= */
  OPT_malign_stringops = 1683,               /* -malign-stringops */
  OPT_march_ = 1684,                         /* -march= */
  OPT_masm_ = 1685,                          /* -masm= */
  OPT_matt_stubs = 1686,                     /* -matt-stubs */
  OPT_mavx = 1687,                           /* -mavx */
  OPT_mavx2 = 1688,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1689,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1690,  /* -mavx256-split-unaligned-store */
  OPT_mavx5124fmaps = 1691,                  /* -mavx5124fmaps */
  OPT_mavx5124vnniw = 1692,                  /* -mavx5124vnniw */
  OPT_mavx512bf16 = 1693,                    /* -mavx512bf16 */
  OPT_mavx512bitalg = 1694,                  /* -mavx512bitalg */
  OPT_mavx512bw = 1695,                      /* -mavx512bw */
  OPT_mavx512cd = 1696,                      /* -mavx512cd */
  OPT_mavx512dq = 1697,                      /* -mavx512dq */
  OPT_mavx512er = 1698,                      /* -mavx512er */
  OPT_mavx512f = 1699,                       /* -mavx512f */
  OPT_mavx512ifma = 1700,                    /* -mavx512ifma */
  OPT_mavx512pf = 1701,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1702,                    /* -mavx512vbmi */
  OPT_mavx512vbmi2 = 1703,                   /* -mavx512vbmi2 */
  OPT_mavx512vl = 1704,                      /* -mavx512vl */
  OPT_mavx512vnni = 1705,                    /* -mavx512vnni */
  OPT_mavx512vp2intersect = 1706,            /* -mavx512vp2intersect */
  OPT_mavx512vpopcntdq = 1707,               /* -mavx512vpopcntdq */
  OPT_mbmi = 1708,                           /* -mbmi */
  OPT_mbmi2 = 1709,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1710,                  /* -mbranch-cost= */
  OPT_mcall_ms2sysv_xlogues = 1711,          /* -mcall-ms2sysv-xlogues */
  OPT_mcet_switch = 1712,                    /* -mcet-switch */
  OPT_mcld = 1713,                           /* -mcld */
  OPT_mcldemote = 1714,                      /* -mcldemote */
  OPT_mclflushopt = 1715,                    /* -mclflushopt */
  OPT_mclwb = 1716,                          /* -mclwb */
  OPT_mclzero = 1717,                        /* -mclzero */
  OPT_mcmodel_ = 1718,                       /* -mcmodel= */
  OPT_mconstant_cfstrings = 1719,            /* -mconstant-cfstrings */
  /* OPT_mcpu_ = 1720, */                    /* -mcpu= */
  OPT_mcrc32 = 1721,                         /* -mcrc32 */
  OPT_mcx16 = 1722,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1723,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1724,            /* -mdump-tune-features */
  OPT_mdynamic_no_pic = 1725,                /* -mdynamic-no-pic */
  OPT_menqcmd = 1726,                        /* -menqcmd */
  OPT_mf16c = 1727,                          /* -mf16c */
  OPT_mfancy_math_387 = 1728,                /* -mfancy-math-387 */
  OPT_mfentry = 1729,                        /* -mfentry */
  OPT_mfentry_name_ = 1730,                  /* -mfentry-name= */
  OPT_mfentry_section_ = 1731,               /* -mfentry-section= */
  OPT_mfix_and_continue = 1732,              /* -mfix-and-continue */
  OPT_mfma = 1733,                           /* -mfma */
  OPT_mfma4 = 1734,                          /* -mfma4 */
  OPT_mforce_drap = 1735,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 1736,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 1737,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1738,                       /* -mfpmath= */
  OPT_mfsgsbase = 1739,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 1740,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1741, */              /* -mfused-madd */
  OPT_mfxsr = 1742,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 1743,             /* -mgeneral-regs-only */
  OPT_mgfni = 1744,                          /* -mgfni */
  OPT_mhard_float = 1745,                    /* -mhard-float */
  OPT_mhle = 1746,                           /* -mhle */
  OPT_miamcu = 1747,                         /* -miamcu */
  OPT_mieee_fp = 1748,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1749,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_register = 1750,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1751,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1752,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1753,  /* -minline-stringops-dynamically */
  OPT_minstrument_return_ = 1754,            /* -minstrument-return= */
  /* OPT_mintel_syntax = 1755, */            /* -mintel-syntax */
  OPT_mkernel = 1756,                        /* -mkernel */
  OPT_mlarge_data_threshold_ = 1757,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1758,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1759,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1760,                /* -mlong-double-80 */
  OPT_mlwp = 1761,                           /* -mlwp */
  OPT_mlzcnt = 1762,                         /* -mlzcnt */
  OPT_mmacosx_version_min_ = 1763,           /* -mmacosx-version-min= */
  OPT_mmanual_endbr = 1764,                  /* -mmanual-endbr */
  OPT_mmemcpy_strategy_ = 1765,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1766,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1767,                  /* -mmitigate-rop */
  OPT_mmmx = 1768,                           /* -mmmx */
  OPT_mmovbe = 1769,                         /* -mmovbe */
  OPT_mmovdir64b = 1770,                     /* -mmovdir64b */
  OPT_mmovdiri = 1771,                       /* -mmovdiri */
  OPT_mmpx = 1772,                           /* -mmpx */
  OPT_mms_bitfields = 1773,                  /* -mms-bitfields */
  OPT_mmwaitx = 1774,                        /* -mmwaitx */
  OPT_mno_align_stringops = 1775,            /* -mno-align-stringops */
  OPT_mno_default = 1776,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1777,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1778,                  /* -mno-push-args */
  OPT_mno_red_zone = 1779,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1780,                       /* -mno-sse4 */
  OPT_mnop_mcount = 1781,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1782,       /* -momit-leaf-frame-pointer */
  OPT_mone_byte_bool = 1783,                 /* -mone-byte-bool */
  OPT_mpc32 = 1784,                          /* -mpc32 */
  OPT_mpc64 = 1785,                          /* -mpc64 */
  OPT_mpc80 = 1786,                          /* -mpc80 */
  OPT_mpclmul = 1787,                        /* -mpclmul */
  OPT_mpcommit = 1788,                       /* -mpcommit */
  OPT_mpconfig = 1789,                       /* -mpconfig */
  OPT_mpku = 1790,                           /* -mpku */
  OPT_mpopcnt = 1791,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 1792, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 1793,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 1794,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1795,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1796,                        /* -mprfchw */
  OPT_mptwrite = 1797,                       /* -mptwrite */
  OPT_mpush_args = 1798,                     /* -mpush-args */
  OPT_mrdpid = 1799,                         /* -mrdpid */
  OPT_mrdrnd = 1800,                         /* -mrdrnd */
  OPT_mrdseed = 1801,                        /* -mrdseed */
  OPT_mrecip = 1802,                         /* -mrecip */
  OPT_mrecip_ = 1803,                        /* -mrecip= */
  OPT_mrecord_mcount = 1804,                 /* -mrecord-mcount */
  OPT_mrecord_return = 1805,                 /* -mrecord-return */
  OPT_mred_zone = 1806,                      /* -mred-zone */
  OPT_mregparm_ = 1807,                      /* -mregparm= */
  OPT_mrtd = 1808,                           /* -mrtd */
  OPT_mrtm = 1809,                           /* -mrtm */
  OPT_msahf = 1810,                          /* -msahf */
  OPT_msgx = 1811,                           /* -msgx */
  OPT_msha = 1812,                           /* -msha */
  OPT_mshstk = 1813,                         /* -mshstk */
  OPT_mskip_rax_setup = 1814,                /* -mskip-rax-setup */
  OPT_msoft_float = 1815,                    /* -msoft-float */
  OPT_msse = 1816,                           /* -msse */
  OPT_msse2 = 1817,                          /* -msse2 */
  OPT_msse2avx = 1818,                       /* -msse2avx */
  OPT_msse3 = 1819,                          /* -msse3 */
  OPT_msse4 = 1820,                          /* -msse4 */
  OPT_msse4_1 = 1821,                        /* -msse4.1 */
  OPT_msse4_2 = 1822,                        /* -msse4.2 */
  OPT_msse4a = 1823,                         /* -msse4a */
  /* OPT_msse5 = 1824, */                    /* -msse5 */
  OPT_msseregparm = 1825,                    /* -msseregparm */
  OPT_mssse3 = 1826,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1827,               /* -mstack-arg-probe */
  ...
  OPT_mstack_protector_guard_symbol_ = 1830, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 1831,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1832,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1833,            /* -mstringop-strategy= */
  OPT_mstv = 1834,                           /* -mstv */
  OPT_msymbol_stubs = 1835,                  /* -msymbol-stubs */
  OPT_mtarget_linker = 1836,                 /* -mtarget-linker */
  /* OPT_mtarget_linker_ = 1837, */          /* -mtarget-linker= */
  OPT_mtbm = 1838,                           /* -mtbm */
  OPT_mtls_dialect_ = 1839,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1840,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1841,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1842,                         /* -mtune= */
  /* OPT_multi_module = 1843, */             /* -multi_module */
  /* OPT_multiply_defined = 1844, */         /* -multiply_defined */
  /* OPT_multiply_defined_unused = 1845, */  /* -multiply_defined_unused */
  OPT_mvaes = 1846,                          /* -mvaes */
  OPT_mveclibabi_ = 1847,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1848,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 1849,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 1850,                    /* -mvzeroupper */
  OPT_mwaitpkg = 1851,                       /* -mwaitpkg */
  OPT_mwbnoinvd = 1852,                      /* -mwbnoinvd */
  OPT_mx32 = 1853,                           /* -mx32 */
  OPT_mxop = 1854,                           /* -mxop */
  OPT_mxsave = 1855,                         /* -mxsave */
  OPT_mxsavec = 1856,                        /* -mxsavec */
  OPT_mxsaveopt = 1857,                      /* -mxsaveopt */
  OPT_mxsaves = 1858,                        /* -mxsaves */
  OPT_n = 1859,                              /* -n */
  OPT_name_sort = 1860,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1861,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1862,              /* -no-integrated-cpp */
  OPT_no_pie = 1863,                         /* -no-pie */
  /* OPT_no_dead_strip_inits_and_terms = 1864, *//* -no_dead_strip_inits_and_terms */
  OPT_nocpp = 1865,                          /* -nocpp */
  OPT_nodefaultlibs = 1866,                  /* -nodefaultlibs */
  OPT_nofixprebinding = 1867,                /* -nofixprebinding */
  OPT_nolibc = 1868,                         /* -nolibc */
  OPT_nomultidefs = 1869,                    /* -nomultidefs */
  OPT_nophoboslib = 1870,                    /* -nophoboslib */
  OPT_noprebind = 1871,                      /* -noprebind */
  OPT_noseglinkedit = 1872,                  /* -noseglinkedit */
  OPT_nostartfiles = 1873,                   /* -nostartfiles */
  OPT_nostdinc = 1874,                       /* -nostdinc */
  OPT_nostdinc__ = 1875,                     /* -nostdinc++ */
  OPT_nostdlib = 1876,                       /* -nostdlib */
  OPT_o = 1877,                              /* -o */
  OPT_object = 1878,                         /* -object */
  OPT_objects = 1879,                        /* -objects */
  OPT_p = 1880,                              /* -p */
  OPT_pagezero_size = 1881,                  /* -pagezero_size */
  OPT_pass_exit_codes = 1882,                /* -pass-exit-codes */
  /* OPT_pedantic = 1883, */                 /* -pedantic */
  OPT_pedantic_errors = 1884,                /* -pedantic-errors */
  OPT_pg = 1885,                             /* -pg */
  OPT_pie = 1886,                            /* -pie */
  OPT_pipe = 1887,                           /* -pipe */
  OPT_prebind = 1888,                        /* -prebind */
  OPT_prebind_all_twolevel_modules = 1889,   /* -prebind_all_twolevel_modules */
  OPT_preload = 1890,                        /* -preload */
  OPT_print_file_name_ = 1891,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1892,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1893,          /* -print-multi-directory */
  OPT_print_multi_lib = 1894,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1895,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1896,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1897,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1898,               /* -print-prog-name= */
  OPT_print_search_dirs = 1899,              /* -print-search-dirs */
  OPT_print_sysroot = 1900,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1901,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1902,                    /* -print-value */
  OPT_private_bundle = 1903,                 /* -private_bundle */
  OPT_pthread = 1904,                        /* -pthread */
  OPT_quiet = 1905,                          /* -quiet */
  OPT_r = 1906,                              /* -r */
  OPT_rdynamic = 1907,                       /* -rdynamic */
  OPT_read_only_relocs = 1908,               /* -read_only_relocs */
  OPT_remap = 1909,                          /* -remap */
  OPT_reverse_sort = 1910,                   /* -reverse-sort */
  OPT_s = 1911,                              /* -s */
  OPT_save_temps = 1912,                     /* -save-temps */
  OPT_save_temps_ = 1913,                    /* -save-temps= */
  OPT_sectalign = 1914,                      /* -sectalign */
  OPT_sectcreate = 1915,                     /* -sectcreate */
  OPT_sectobjectsymbols = 1916,              /* -sectobjectsymbols */
  OPT_sectorder = 1917,                      /* -sectorder */
  OPT_seg1addr = 1918,                       /* -seg1addr */
  /* OPT_seg_addr_table = 1919, */           /* -seg_addr_table */
  /* OPT_seg_addr_table_filename = 1920, */  /* -seg_addr_table_filename */
  /* OPT_segaddr = 1921, */                  /* -segaddr */
  OPT_segcreate = 1922,                      /* -segcreate */
  OPT_seglinkedit = 1923,                    /* -seglinkedit */
  OPT_segprot = 1924,                        /* -segprot */
  /* OPT_segs_read_only_addr = 1925, */      /* -segs_read_only_addr */
  /* OPT_segs_read_write_addr = 1926, */     /* -segs_read_write_addr */
  OPT_shared = 1927,                         /* -shared */
  OPT_shared_libgcc = 1928,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1929,               /* -shared-libphobos */
  /* OPT_single_module = 1930, */            /* -single_module */
  OPT_size_sort = 1931,                      /* -size-sort */
  /* OPT_specs = 1932, */                    /* -specs */
  OPT_specs_ = 1933,                         /* -specs= */
  OPT_static = 1934,                         /* -static */
  OPT_static_libasan = 1935,                 /* -static-libasan */
  OPT_static_libgcc = 1936,                  /* -static-libgcc */
  OPT_static_libgfortran = 1937,             /* -static-libgfortran */
  OPT_static_libgo = 1938,                   /* -static-libgo */
  OPT_static_liblsan = 1939,                 /* -static-liblsan */
  OPT_static_libmpx = 1940,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1941,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1942,               /* -static-libphobos */
  OPT_static_libstdc__ = 1943,               /* -static-libstdc++ */
  OPT_static_libtsan = 1944,                 /* -static-libtsan */
  OPT_static_libubsan = 1945,                /* -static-libubsan */
  OPT_static_pie = 1946,                     /* -static-pie */
  /* OPT_std_c__03 = 1947, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1948, */                /* -std=c++0x */
  OPT_std_c__11 = 1949,                      /* -std=c++11 */
  OPT_std_c__14 = 1950,                      /* -std=c++14 */
  OPT_std_c__17 = 1951,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1952, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1953, */                /* -std=c++1z */
  /* OPT_std_c__20 = 1954, */                /* -std=c++20 */
  OPT_std_c__2a = 1955,                      /* -std=c++2a */
  OPT_std_c__98 = 1956,                      /* -std=c++98 */
  OPT_std_c11 = 1957,                        /* -std=c11 */
  OPT_std_c17 = 1958,                        /* -std=c17 */
  /* OPT_std_c18 = 1959, */                  /* -std=c18 */
  /* OPT_std_c1x = 1960, */                  /* -std=c1x */
  OPT_std_c2x = 1961,                        /* -std=c2x */
  /* OPT_std_c89 = 1962, */                  /* -std=c89 */
  OPT_std_c90 = 1963,                        /* -std=c90 */
  OPT_std_c99 = 1964,                        /* -std=c99 */
  /* OPT_std_c9x = 1965, */                  /* -std=c9x */
  OPT_std_f2003 = 1966,                      /* -std=f2003 */
  OPT_std_f2008 = 1967,                      /* -std=f2008 */
  OPT_std_f2008ts = 1968,                    /* -std=f2008ts */
  OPT_std_f2018 = 1969,                      /* -std=f2018 */
  OPT_std_f95 = 1970,                        /* -std=f95 */
  OPT_std_gnu = 1971,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1972, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1973, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1974,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1975,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1976,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1977, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1978, */              /* -std=gnu++1z */
  /* OPT_std_gnu__20 = 1979, */              /* -std=gnu++20 */
  OPT_std_gnu__2a = 1980,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1981,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1982,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1983,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1984, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1985, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1986,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1987, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1988,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1989,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1990, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1991, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1992,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1993, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1994, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1995, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1996, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1997, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1998,                     /* -std=legacy */
  OPT_sub_library = 1999,                    /* -sub_library */
  OPT_sub_umbrella = 2000,                   /* -sub_umbrella */
  OPT_symbol_ = 2001,                        /* -symbol= */
  OPT_symbolic = 2002,                       /* -symbolic */
  OPT_t = 2003,                              /* -t */
  OPT_time = 2004,                           /* -time */
  OPT_time_ = 2005,                          /* -time= */
  OPT_traditional = 2006,                    /* -traditional */
  OPT_traditional_cpp = 2007,                /* -traditional-cpp */
  OPT_tree_stats = 2008,                     /* -tree-stats */
  OPT_trigraphs = 2009,                      /* -trigraphs */
  OPT_twolevel_namespace = 2010,             /* -twolevel_namespace */
  OPT_twolevel_namespace_hints = 2011,       /* -twolevel_namespace_hints */
  OPT_type_stats = 2012,                     /* -type-stats */
  OPT_u = 2013,                              /* -u */
  /* OPT_umbrella = 2014, */                 /* -umbrella */
  OPT_undef = 2015,                          /* -undef */
  OPT_undefined = 2016,                      /* -undefined */
  /* OPT_unexported_symbols_list = 2017, */  /* -unexported_symbols_list */
  OPT_v = 2018,                              /* -v */
  OPT_version = 2019,                        /* -version */
  OPT_w = 2020,                              /* -w */
  /* OPT_weak_reference_mismatches = 2021, *//* -weak_reference_mismatches */
  OPT_whatsloaded = 2022,                    /* -whatsloaded */
  OPT_whyload = 2023,                        /* -whyload */
  OPT_wrapper = 2024,                        /* -wrapper */
  OPT_x = 2025,                              /* -x */
  OPT_y = 2026,                              /* -y */
  OPT_z = 2027,                              /* -z */
  N_OPTS,
