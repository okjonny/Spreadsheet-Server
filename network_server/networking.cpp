...
namespace network_util {
    ...
    int networking::start_server(std::function<socket_state(socket_state)> &to_call) {
    ...
    void networking::accept_new_clients(std::function<socket_state(socket_state)> &to_call) {
...
//            threads[thread_id] = std::thread([this] { receive_callback(thread_id); });
//            threads[thread_id] = std::thread(std::bind(&networking::receive_callback, this, thread_id));
